...
description: "How to write a Natural Sciences personal statement for UK universities. What admissions tutors look for at Cambridge, Durham, UCL, Bath and Lancaster."
subject: "Natural Sciences"
form_cta: "Build a Natural Sciences statement that satisfies the Cambridge Tripos and single-subject tutors"
form_intro: "Tell us which two or three sciences you want to combine, which course shapes you're applying for, and what reading you've done. We'll help you turn that into a statement that works for all five UCAS choices."
form_message_label: "Which sciences are you combining, and where are you applying?"
form_message_placeholder: "For example: applying to Cambridge Nat Sci, Durham Nat Sci, and three single-subject Chemistry courses; interested in physics and chemistry; read The Selfish Gene and parts of A Brief History of Time; did an EPQ on catalysis; worried my statement sounds split between two subjects."
form_button: "Get Natural Sciences statement help"
form_note: "We'll reply with advice on writing one statement that lands at Cambridge and at single-subject departments."
related_pages:
