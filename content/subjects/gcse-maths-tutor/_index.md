---
title: "GCSE Maths Tutors | The Degree Gap"
description: "Your child is working hard and the Maths grade is not moving. A 40-minute consultation with Joe, then free trial calls with the tutors he matches you with. From £37/hr. No card details until you have chosen a tutor."
...
banner_heading: "GCSE Maths Tutors"
banner_description: "They are working. The marks do not match the effort. A 40-minute consultation with Joe, then free trial calls with the tutors he matches you with. From £37/hr."
...
hero_alt: "Joe and Harry, co-founders of The Degree Gap, with the GCSE Specialists of the Year award"

# ───────────── WHY DIFFERENT ─────────────
why_heading: "Why parents bring their Maths problem to us"
why_blocks:
  - title: "We have met every tutor we put in front of you"
    body: "The worst part of finding a tutor is usually the not-knowing. A name from a directory. A graduate from a website. We changed that bit. Joe and Harry have personally interviewed every tutor on our platform. About 33 apply for every one we say yes to. The name we send you has already been through people who know what GCSE Maths actually rewards."
  - title: "Your child's exact paper, not just 'Maths'"
    body: "AQA and Edexcel look like the same subject. They are not. The mark schemes are different, the questions are different, and the way examiners award the top band is different. If your child is being taught one board and tutored using another, the marks suffer. Not sure which board your child is on? Joe will help you find out on the first call."
  - title: "We start by listening, not selling"
    body: "Most parents who reach us cannot name exactly what is going wrong. Only that the work is going in and the grade is not moving. That is what the 40-minute consultation with Joe is for. He listens. He asks about the predicted grade, the mock that came back lower than hoped, the Maths topic the school moved past too quickly. Then he matches a small shortlist of tutors who can do something about it."

# ───────────── HOW IT WORKS ─────────────
how_heading: "From your first message to your child's first paid session"
how_steps:
  - title: "A 40-minute consultation with Joe"
    body: "When you enquire, Joe will call you back to arrange a time that works. The consultation itself is a proper 40-minute conversation about what is going on with your child's Maths. The exam board. The predicted grade. The mock that did not land. The topic the school moved past too quickly. He listens, asks the right questions, then starts thinking about which tutors would actually fit."
  - title: "Free trial calls with two or three tutor matches"
    body: "Joe sends a shortlist of two or three tutors he thinks could work for your child. Each one offers a free trial call so you can meet them. You see how they explain things. You see who your child actually clicks with. No commitment after, no card details, no awkward pressure."
  - title: "You pick the tutor that fits, and sessions begin"
    body: "From the trial calls, you choose the tutor that feels right for your child. Weekly sessions start on Lessonspace, our shared whiteboard. Pay per session. No contracts. If at any point this is not working, you stop."
...
# ───────────── MEET THE FOUNDERS ─────────────
founders_heading: "Meet Joe and Harry"
founders_eyebrow: "Who runs The Degree Gap"
founders_body: "We are Joe and Harry. We started The Degree Gap because we kept watching the same thing happen. A bright Year 10 or 11 student. Hours at the desk every weekend. A predicted Maths grade that was not moving. The parents had tried, the school had tried, the student had tried. What was missing was someone whose only job was to find the actual gap and close it. Between us we have over 5,000 hours of one-to-one teaching, an LSE Economics degree, and a strong opinion about what makes the difference at GCSE Maths. We personally interview every tutor on the platform. About three percent get through. And every family speaks with one of us before a tutor is matched."
founders_image: "/images/founders-award.jpg"
founders_image_alt: "Joe and Harry, co-founders of The Degree Gap, with the GCSE Specialists of the Year award"
founders_cta: "Book your free call"

# ───────────── PARENT VOICES (reviews surfaced from data) ─────────────
voices_heading: "What parents tell us, in their own words"
voices_eyebrow: "Parent voices"
voices_intro: "Real reviews from real Degree Gap families. The ones below were chosen because they speak to what tutoring actually changes, the parts that show up at the kitchen table, not just on the report card."
voices:
  - name: "Sarah K"
    role: "Parent of GCSE Maths Student"
    text: "My son's grade went from a 4 to a 7 in Maths in a single term. The tutor found exactly where things had stopped clicking, years earlier than we thought, and worked through it methodically. The biggest change was not even the grade. It was how calm he was walking into the exam."
  - name: "Ellen"
    role: "Parent of GCSE Maths Student"
    text: "My daughter was struggling with confidence in Maths GCSE and we decided to get a tutor. We were given a selection of tutors to choose from and told that if it did not feel like a good match we could try others. Our tutor was a complete star, listened, made it simple, set good homework and gave my daughter her confidence back."
  - name: "Daljit"
    role: "Parent of A-Level Student"
    text: "My son gained almost two grades higher than his Year 13 mock paper. His tutor was excellent, patient, knowledgeable, and genuinely invested in his progress."
  - name: "Heidi"
  ...
  - name: "Annette"
    role: "Parent"
    text: "This company helped us find a tutor for Geography and my son has excelled so much in just a few months. Our tutor has gone above and beyond, demonstrating incredible patience and encouraging my son to believe in himself. He also manages neurodiversity well."
  - name: "Lisa"
    role: "Parent of Two Students"
    text: "The Degree Gap has exceeded all my expectations. They have gone above and beyond to pair both my sons with the appropriate tutors, all of whom have been exceptional. Both my sons exceeded their expected grades and got into their first-choice universities."
...
# ───────────── FINAL FORM ─────────────
form_cta: "Tell Joe what is going wrong"
form_intro: "Joe will call you back within one working day to arrange a 40-minute consultation. No sales pitch. No obligation. In the consultation he will ask about the exam board, the predicted grade, the mock that did not land, and what you have already tried. Then he will send you a shortlist of two or three tutors with free trial calls, so you can pick the one that fits. If he does not think tutoring is the right move for now, he will tell you that too."
