...
related_links:
  ...
  - title: "Is a GCSE tutor actually worth it?"
    url: "/blog/is-a-gcse-tutor-worth-it/"
...
|---|---|---|
| Technique and exam-timing fixes | 4 to 8 | Fastest wins available. Knowledge already in place. |
| One specific topic gap | 6 to 12 | Fix, then apply across papers to make it stick. |
| One grade band, foundations sound | 12 to 20 | Roughly a term to two terms at one hour a week. |
| One grade band, foundations shaky | 24 to 30 | Two to three terms. Rebuilding takes the time it takes. |
...
- [Education Endowment Foundation, One to One Tuition toolkit strand](https://educationendowmentfoundation.org.uk/education-evidence/teaching-learning-toolkit/one-to-one-tuition) for months of additional progress, the primary and secondary split, the delivery-pattern findings, the study count and the evidence caveats.

The session ranges in the table above are our own observed patterns, not published research, and are labelled as such deliberately. The review quoted is real and verbatim.
