...
intro_2: "Our Canterbury tutors work with families through every part of that. For Year 5 and 6 families, that means proper Kent Test preparation in reasoning, English and Maths well before the autumn. For grammar school students, it's keeping pace when the curriculum moves at speed and the homework load steps up sharply at A-Level. For students at any other secondary in Canterbury, it's making sure ambition gets the one-to-one attention a class of thirty rarely has time for. And for sixth formers, it's the analytical depth A-Level demands, regardless of which school they came up through."
...
why_para_1: "Across Canterbury, the same conversation tends to come up. A bright student. A school doing its honest job. But by Year 12 the A-Level mock has come back at a B and nobody can quite say why. The gap is rarely content, most students know the content. It's the analytical precision A-Level rewards, the structure shift from a strong GCSE essay to an A-Level one, that a class of thirty rarely has time to drill student by student. That's the bit a tutor steps into."
