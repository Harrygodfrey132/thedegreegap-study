---
title: "GCSE English Tutors Covering Stockport | The Degree Gap"
nav_title: "English"
description: "Online GCSE English tutors covering Stockport for Language and Literature. A predicted grade that dropped on one timed essay, steadied, from £37 an hour."
...
angle_body_1: "Of all the GCSEs, English is the one whose predicted grade wobbles most, because it rests on a handful of timed essays rather than a bank of right-or-wrong answers. One thin Macbeth response in a November mock and the prediction slides a grade. In Stockport that number does real work: it travels with the college application in the autumn of Year 11 and frames every conversation about whether a course is realistic. The usual culprits are specific. Language Paper 1 Question 5, the creative writing, running out of time. The Literature extract answered without ever reaching the rest of the play. Poetry compared line by line instead of idea by idea. And the unseen poem, panicked through in ten minutes."
angle_body_2: "The first session is a marked essay read next to the mark scheme, so the student can see which assessment objective the marks came off. Usually it is one habit rather than a general weakness, and one habit is fixable inside a term of weekly work: planning for four minutes before writing, or quoting from memory across the whole text, or timing the paper by marks per minute. Then the prediction has evidence behind it when the school reviews it in the spring. The colleges across Stockport, Aquinas among them, name English Language inside their grade-4 minimum, and Stockport Grammar wants an average of grade 6 across the best eight for its sixth form."
...
angle_stat_from: "5"
angle_stat_to: "7"
angle_stat_detail: "Where a term of weekly one-to-one GCSE English sessions is typically aimed once the essay habit behind a dropped prediction has been fixed."
...
steps_heading: "Start online GCSE English tutoring in Stockport in 3 steps"
...
faqs:
  ...
  - q: "Why is my child's English predicted grade lower than I expected?"
    a: "Because an English prediction rests on a few timed essays and one of them went wrong. Teachers predict from mock performance and judgement, and in English a single thin Literature answer can move the number a whole grade, in a way one bad Maths question never could. Parents notice the gap between what the child says about the text at home and what reached the page in forty-five minutes. A tutor reads the marked essay against the scheme and names the habit: no plan, no quotation from beyond the extract, or the clock. Fix that and the evidence for a higher prediction exists by the spring review."
