...
description: "Derby A-Level tutors who close the depth-gap between Year 12 mocks and the predicted grade UCAS sees. Maths, Sciences, Economics and more, matched per specification."
layout: "subject"
location: "Derby"
level: "A-Level"
grade_from: "E"
...
hero_heading_line2: ""
hero_lead: "Our Derby A-Level tutors lift predicted grades by a band, sometimes two, before UCAS sees them. Most start in Year 12, ahead of the January mocks that lock the offer band in for good."
...
tutor_strip_body: "Our Derby A-Level tutors have worked with Year 12s and 13s aiming at Loughborough, the University of Nottingham, Sheffield and the wider Russell Group. Browse the roster, or we'll make the introduction."
...
faq_1_q: "My son got a grade 8 at GCSE Maths but is struggling at A-Level. What's going on?"
faq_1_a: "But A-Level Maths is genuinely a different subject from GCSE, especially the pure-mechanics-stats balance. Derby A-Level tutors find that gap in the first session, usually on a past paper, and the plan from session two builds the depth Year 13 papers actually demand."
faq_2_q: "My daughter is struggling with A-Level Sciences. What does a tutor do differently?"
faq_2_a: "First session is diagnostic, usually on a recent past paper. An A-Level Sciences tutor in Derby works out whether the gap is content (A2 building on A1 foundations), exam technique (the long-answer questions where AO3 marks live) or the calculation steps under timed pressure. The plan from session two builds back from where the gap actually started."
faq_3_q: "What does Derby A-Level retake support look like?"
faq_3_a: "Different from first-attempt tutoring. Retake students usually know the content but need to fix what went wrong on exam day, where pacing slipped, where evaluation went shallow. We pair Derby retake students with A-Level tutors who've coached the exact specification before, and the work is faster and more targeted than a Year 12 plan."
faq_4_q: "How much does A-Level tutoring in Derby cost per session?"
faq_4_a: "From £37 per hour. The rate depends on the subject and the tutor, agreed before booking. Most Derby families settle on weekly hour-long sessions through Year 12, with a second session added in the run-up to Year 13 January mocks."
