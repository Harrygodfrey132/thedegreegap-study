...
first_lesson_context: But by Year 11, most Derby gaps trace back to specific
  topics that quietly compounded through Year 8 and 9. A Derby GCSE tutor finds
  that root in week one, and the GCSE tutoring plan builds back from there.
...
tutor_strip_body: Our Derby GCSE tutors have worked with Year 10 and 11 students
  across Chellaston, Ecclesbourne, Bemrose and Allestree. Browse the roster, or
...
pathways:
  - title: Sixth Forms
    body: >
      Chellaston Academy Sixth and Ecclesbourne School lead the local sixth-form
      performance, with Littleover and Allestree Woodlands sitting alongside
      them. A GCSE Maths tutor or GCSE English tutor in Year 11 lifts the
      predicted grade towards what these sixth forms actually ask for.
  - title: Apprenticeships
    body: >
      Rolls-Royce at Sinfin and Toyota at Burnaston run Derby's biggest Year 11
      engineering apprenticeship intakes, with Alstom adding rail-engineering
      routes from Litchurch Lane. Most have published minimum-grade requirements
      in Maths and English, with GCSE Sciences tutoring often the difference for
      the technical route.
  - title: Further Education
    body: >
      Derby College runs the city's main BTEC and T Level routes from the
      Roundhouse Campus in Pride Park and the Joseph Wright Centre in town.
      One-to-one GCSE tutoring in Year 11 lifts students past the minimum Level
...
reviews:
  ...
  - Marfa|Student|Very engaging lessons that helped me improve my grade in maths
    and successfully get admitted to university.
...
faq_1_a: Common in Year 10 after a rough Year 9. We start by tracing the gap
  back to where things actually stopped clicking, and the plan builds from there
  rather than racing to keep pace with current classroom content. Derby GCSE
  tutors with experience of behind-target students usually rebuild the basics
  inside two terms.
faq_2_q: How does online GCSE tutoring in Derby work?
faq_2_a: Almost all of it runs online over Lessonspace, our one-to-one platform
  with an interactive shared whiteboard. Derby families like it because they're
  matched with the right tutor for the subject and exam board, not just the
  nearest geographically. Most students settle into it from the first session.
faq_3_q: My daughter is struggling with GCSE Maths in Derby. What can a tutor
  actually do?
faq_3_a: First session is diagnostic. A Derby GCSE Maths tutor works through a
  recent past paper to find the topics losing the most marks, usually in algebra
  rearrangement or the 9-mark problem-solving question. The plan from session
  two builds back from where the gap actually started, not from the textbook.
faq_4_q: How much does GCSE tutoring in Derby cost?
faq_4_a: From £37 per hour. The rate depends on the subject and the tutor, and
  it's agreed before anything is booked. Most Derby families settle on weekly
  hour-long sessions through Year 10 and 11, with an extra session added in the
  run-up to November and March mocks.
sitemap:
  priority: 0.7
  changefreq: monthly
---
