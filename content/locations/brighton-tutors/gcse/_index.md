---
title: "GCSE Tutors in Brighton | Online One-to-One | The Degree Gap"
description: "Brighton GCSE tutoring matched on subject and exam board, from English essays to Maths method. One-to-one tutors who lift the grade the city's colleges ask for."
layout: "subject"
location: "Brighton"
level: "GCSE"
...
grade_from: "5"
grade_to: "7"
grade_stat: "A real GCSE English grade jump, from a 5 to a 6/7, after six months of weekly one-to-one tutoring."

first_lesson_eyebrow: "ONE BRIGHTON ENGLISH TURNAROUND"
first_lesson_heading: "How a Brighton GCSE Tutor Rebuilds a Stalled English Grade"
first_lesson_context: "In Brighton the GCSE grade buys a college place, and with BHASVIC and Varndean College both heavily oversubscribed, there's no grammar school anywhere in the city softening the bar. Results here sit around and a little above the national picture now, which hides how much can ride on one wobbling subject. A GCSE tutor goes at that subject first, the one where the place is won or lost, and works back to where the marks started slipping."
...
tutor_strip_body: "Most of our Brighton GCSE tutors are recent Russell Group graduates who cleared a founder-led interview that only about 3% of applicants get through. They've walked students through the AQA, Edexcel and OCR specs the city's comprehensives teach, from Dorothy Stringer to Blatchington Mill. Browse profiles, or let us match your child."

pathways_heading: "Where Brighton Year 11s Head After GCSEs"
pathways_lead: "Wondering what comes after Year 11 in Brighton? These are the three routes most families weigh up."
pathways:
  - title: "Sixth Forms"
    body: >
      BHASVIC, Varndean College and Cardinal Newman's own sixth form take the biggest share of the city's Year 11s, and BHASVIC and Varndean are both standalone colleges rather than school sixth forms, both regularly oversubscribed. Under the local Accord system a student applies to one or the other, and each publishes its own grade requirements, usually a set of grade 4s with a higher ask in the subjects you want to carry on.
  - title: "Apprenticeships"
    body: >
      American Express runs its European operation out of Amex House in Brighton and takes school-leaver and degree apprentices across tech, finance and operations. Octopus Energy and the city's digital and gaming studios hire locally too, most asking for grade 4 to 5 in Maths and English before the technical routes look at the Sciences.
  - title: "Further Education"
    body: >
      Greater Brighton Metropolitan College, formed from the old City College Brighton and Northbrook, runs the city's main BTEC and T Level courses across its Brighton and Hove campuses. GCSE Maths and English resits are the usual entry point, and one-to-one tutoring is often what closes that last half-grade.
...
faq_1_q: "My daughter understands the English texts but her marks won't move. What does a Brighton GCSE tutor actually do?"
faq_1_a: "The texts usually aren't the problem. What a tutor finds is the writing under timed conditions, essay structure that drifts or a point made but never tied back to the question. The tutor marks recent work the way the exam board marks it, shows her exactly where the marks are going, and rebuilds the technique on past papers. And English Language and English Literature are genuinely different exams, so we match a tutor who knows the one she's losing marks in."
faq_2_q: "We're hoping for a BHASVIC or Varndean College place. How does GCSE tutoring help with that?"
faq_2_a: "Both colleges are oversubscribed and publish their own grade requirements, usually a set of grade 4s with a higher ask in the subjects your child wants to carry on to A-Level. A tutor works those subjects first, drilling the question types that move a grade fastest rather than re-teaching everything. Most families see the predicted grade shift within a half term of weekly sessions."
faq_3_q: "Is Brighton GCSE tutoring online, and does that actually work?"
faq_3_a: "Yes, every session runs online through Lessonspace, our shared whiteboard. The tutor and student work on the same screen, mark papers together live, and the whole thing is recorded so your child can rewatch the parts that didn't stick. Brighton families like that there's no cross-city trek on a school night, and that the right subject specialist matters more than who lives nearest."
faq_4_q: "How much does GCSE tutoring in Brighton cost?"
faq_4_a: "From £37 an hour. The rate depends on the tutor's subject and experience: a recent graduate teaching their own GCSE subject sits at the entry rate, a qualified examiner sits higher. We agree it with you before anything is booked. No contracts, no waiting lists."
