---
title: "Tonbridge GCSE Tutors | Online One-to-One | The Degree Gap"
description: "Friendly Tonbridge GCSE tutors, one-to-one and online, for the grades each sixth form asks for. Tutor profiles within 24 hours, lessons from £37, no contract."
layout: "subject"
location: "Tonbridge"
level: "GCSE"
...
grade_from: "5"
grade_to: "6/7"
grade_stat: "One parent tells us her Year 10 son went from a grade 5 to a 6/7 in English after six months of tutoring."

first_lesson_eyebrow: "ONE YEAR 10, SIX MONTHS ON"
first_lesson_heading: "What the First Lesson With a Tonbridge GCSE Tutor Looks Like"
first_lesson_context: "The call we hear most from Tonbridge parents goes something like this: my child works hard, the teachers are kind, and the mock still came back lower than anyone expected. So the first lesson is spent on that mock, question by question, until the GCSE tutor can point to where the marks actually went."
...
tutor_strip_heading: "Tonbridge GCSE tutors picked for your child's exam board"
tutor_strip_body: "Judd, Hillview, Weald of Kent and Hugh Christie don't all enter the same boards, and brothers and sisters often sit different papers. So we check the board first. Have a look at some profiles, or let us do the matching."

pathways_heading: "Where Tonbridge Year 11s Go After the Summer"
pathways_lead: "Most families weigh up three routes, and the grades each one asks for are quite different."
pathways:
  - title: "Sixth Forms"
    body: >
      The Judd School asks for an average of 6.5 across a student's best ten qualifications, with at least a 4 in Maths and English Language, while Weald of Kent Grammar School asks for an average of 5.5 across the best eight and a 5 in English. Hillview School for Girls, which takes boys into its sixth form, asks for a 4 in Maths and English Language plus three more subjects at 4 or above.
  - title: "Apprenticeships"
    body: >
      West Kent College, right in Tonbridge, runs apprenticeships from intermediate up to higher level in trades such as construction, electrical, engineering and motor vehicle work. Kings Hill business park near West Malling, home to Tonbridge and Malling Borough Council's offices, is the other big cluster of employers close by.
  - title: "Further Education"
    body: >
      West Kent College teaches A-Levels, BTECs and GCSE resits alongside its vocational courses. Leigh Academy Hugh Christie and Leigh Academy Tonbridge both keep sixth forms of their own, with vocational routes that start from grade 4s in English and Maths.
...
faq_1_a: "It depends a lot on which one. The Judd School works from an average across a student's best ten qualifications, with at least a 4 in Maths and English Language. Weald of Kent uses an average across the best eight plus a 5 in English. Hillview asks for 4s in Maths and English Language and three other subjects. Most also set their own grade for each A-Level subject. These change from year to year, so check the current guide for the sixth form your child likes."
faq_2_q: "Is Year 10 too early to start GCSE tutoring?"
faq_2_a: "Not at all. Year 10 is often the easiest time, because there's room to go back and fix a wobbly topic before Year 11 piles more on top. Lessons then are more about understanding than exam practice. Year 11 is still a good time to start, and plenty of Tonbridge families do, usually in the autumn before the mocks. The work just gets more focused on past papers and timing as the exams get closer."
faq_3_q: "Our children sit different exam boards. Does that matter for tutoring?"
faq_3_a: "Yes, and it's worth knowing early. AQA, Edexcel and OCR cover a lot of the same content, but they ask questions in different ways and mark them differently. A tutor who knows your child's exact board can start on real past questions from the first lesson. That's why we match each child separately. Not sure which board it is? It's usually printed on the front of a mock paper, or we can work it out together on the consultation call."
faq_4_q: "What if we don't click with the tutor?"
faq_4_a: "Just tell us and we'll find someone else, with no charge and no awkward conversation. It happens, and we'd much rather sort it than have your child sit through lessons that aren't working. It's also why you see 2 or 3 tutor profiles before choosing, and why your child meets the tutor on a free 15-minute video call first. There's nearly always a good second option."
