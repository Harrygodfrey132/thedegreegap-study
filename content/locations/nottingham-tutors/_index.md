...
intro_1: Nottingham City has ranked among the lowest-performing local
  authorities in England on Progress 8 for several years running. That's an
  area-level picture, not a comment on any individual school, but it means a lot
  of capable students across the city are finishing Key Stage 4 without the
  foundations their ambition requires. The city has two universities, strong
  graduate aspiration, and families who want more for their children. The gap
  between that aspiration and what state school results currently reflect is
  real, and it's the gap tutoring is built to close.
intro_2: "One-to-one tuition works differently from a classroom because a tutor
  can stop. Not just slow down, but actually go back. Back to where
  understanding broke down, back to the concept that was rushed, back to the
  question the student never felt safe asking. The Degree Gap tutoring matches
  Nottingham students with tutors who do exactly that. Whether a student is in
  Year 9 and starting to fall behind, or in Year 13 and finding A-Level content
  has exposed a shaky base from GCSE, the approach is the same: find what's
  missing, fix it properly, then build forward."
about_heading: Tutors Who Know What Nottingham Students Need
about_image: /images/students-in-classroom-taking-notes.jpg
schools_intro: We work with students from secondary schools across Nottingham,
  including Trinity Catholic School, Farnborough Spencer Academy, The Becket
  School and Bluecoat Wollaton Academy. Students from West Bridgford School and
  The Nottingham Emmanuel School also come to us regularly for GCSE and A-Level
  tutoring support. We run workshops on revision strategy and exam technique
  that are open to students from any school in the area.
schools:
...
online_heading: "Online tuition for Nottingham students: the right tutor, not
  just the nearest one"
online_1: Nottingham sits between some strong university cities, but the pool of
  specialist tutors in any single subject and exam board is always smaller in
  person than online. All our sessions run through Lessonspace, a platform built
  for online tutoring with an interactive whiteboard. Students work with whoever
  is genuinely the best fit, not whoever happens to live nearby.
online_2: "Online tutoring also removes the biggest barrier to keeping sessions
  regular: travel and scheduling. Consistency matters more than intensity. A
  student who meets their tutor every week throughout a term builds far more
  than one who books a block of sessions the week before mocks. Most Nottingham
  students are comfortable with the format from the very first session, and
  parents tell us the weekly rhythm is exactly what their child needed."
...
areas_intro: Because most of our tuition is online, students in Nottingham and
...
gcse_subjects:
  - GCSE Maths Tuition|Targeted work that traces gaps back to their root and
    builds solid understanding from there, rather than repeating content that
    hasn't yet clicked.|https://thedegreegap.com/teachers/languages/GCSE-Maths
  - GCSE History Tuition|Sharp essay technique and confident source analysis
    developed from scratch, giving students a reliable method they can take into
    any exam question.|https://thedegreegap.com/teachers/languages/GCSE-History
  - GCSE Computer Science Tuition|Support that makes programming logic and
    ...
    up.|https://thedegreegap.com/teachers/languages/GCSE-Computer-Science
  - GCSE English Tuition|Close reading, essay structure and language analysis
    ...
    real strategy.|https://thedegreegap.com/teachers/languages/GCSE-English
  - GCSE Geography Tuition|Case studies, data response and extended writing
    ...
    time to cover
    fully.|https://thedegreegap.com/teachers/languages/GCSE-Geography
  - GCSE Chemistry Tuition|Organic, inorganic and physical chemistry broken down
    ...
    them.|https://thedegreegap.com/teachers/languages/GCSE-Chemistry
  - GCSE French Tuition|Speaking, listening, reading and writing practised in a
    ...
    audience.|https://thedegreegap.com/teachers/languages/GCSE-French
  - GCSE Biology Tuition|Cell biology, genetics and ecology explained with
    ...
    know.|https://thedegreegap.com/teachers/languages/GCSE-Biology
  - GCSE Physics Tuition|Forces, energy and electricity taught with a focus on
    ...
    ones.|https://thedegreegap.com/teachers/languages/GCSE-Physics
alevel_subjects:
  ...
  - A-Level Maths Tuition|Advanced support across pure maths, mechanics and
    ...
    first.|https://thedegreegap.com/teachers/languages/A-level-Maths
  - A-Level Geography Tuition|Analytical writing, fieldwork interpretation and
    ...
    them.|https://thedegreegap.com/teachers/languages/A-level-Geography
  - A-Level English Tuition|Critical analysis and essay writing developed
    ...
    alone.|https://thedegreegap.com/teachers/languages/A-level-English
  - A-Level Biology Tuition|Genetics, ecology and physiology at depth, supported
    ...
    see.|https://thedegreegap.com/teachers/languages/A-level-Biology
  - A-Level History Tuition|Complex argument construction and precise historical
    ...
    genuine analytical
    depth.|https://thedegreegap.com/teachers/languages/A-level-History
  - A-Level Economics Tuition|Micro and macroeconomic models, policy evaluation
    ...
    allows.|https://thedegreegap.com/teachers/languages/A-level-Economics
  - A-Level Physics Tuition|Advanced mechanics, fields and quantum physics
    ...
    course.|https://thedegreegap.com/teachers/languages/A-level-Physics
  - A-Level Chemistry Tuition|Organic, inorganic and physical chemistry at
    ...
    marks.|https://thedegreegap.com/teachers/languages/A-level-Chemistry
other_subjects:
...
faq_1_a: Yes. Some of the students we work with in Nottingham have gaps
...
faq_2_a: Most students notice something within the first few sessions. Not
...
faq_4_a: Maths, English, Biology, Chemistry, Physics, History, Geography,
  Economics, Psychology, French and more, across both GCSE and A-Level. If you
  don't see the subject listed, just ask. We will tell you honestly whether we
  can help.
why_heading: How The Degree Gap tutoring works for Nottingham students
why_para_1: "Students from Nottingham who come to us for tutoring tend to have
  one thing in common: they've been keeping up on the surface while falling
  behind underneath. They follow the lesson, they write up the notes, but when
  the exam paper arrives they freeze on questions that mix topics together.
  That's not a revision problem. It's a foundation problem. The first tutoring
  session is usually about finding exactly where the ground became unstable,
  which is often earlier than the student realises."
why_para_2: From there, tutors work in a specific direction. Not forwards
  through the syllabus, but back to where things stopped making sense, then
  forward again, more solidly. It's slower at first. But students start
  answering questions they previously skipped entirely, and that shift tends to
  build quickly. Parents in Nottingham often tell us the first change they
  notice is confidence, not grades. The grades follow, usually within a term.
accordion_quality: Every tutor working with Nottingham students is assessed on
  how well they explain, not just what they know. For a city where attainment
  gaps often start early and compound across year groups, that clarity and
  patience matters more than an impressive CV.
accordion_experience: Our tutors understand the specific patterns that emerge
  when students have missed earlier material and been passed along regardless.
  They know how to find the gap fast and work through it without making a
  student feel like they're starting from scratch.
accordion_personalised: Every tutoring session is built around what that student
  actually needs, not what a student at their year group should need. For
  Nottingham students with unaddressed foundation gaps, the diagnostic first
  session is what makes everything after it count.
reviews:
