---
title: "Plymouth GCSE Science Tuition | From £37/hr"
nav_title: "Science"
description: "Online GCSE Science tutors covering Plymouth for triple and combined award, from required practicals to the six-mark answers. One-to-one from £37 an hour."
layout: "level-subject"
location: "Plymouth"
level: "GCSE"
subject: "Science"

hero_h1: "Online GCSE Science tutors Plymouth parents call when one grade hides three subjects"
hero_lead: "Combined Science arrives as a single number, and a single number will not tell you which lesson to worry about. Our Plymouth GCSE Science tutors take the three apart first, one-to-one online over Lessonspace, before spending a term on any of them."

angle_eyebrow: "ONE GRADE, THREE TEACHERS"
angle_heading: "Which of the Three Sciences Is Actually Costing the Grade"
...
steps_heading: "Start online GCSE Science tutoring in Plymouth in 3 steps"
steps_lead: "Two or three profiles inside a day. Most of the value here is in knowing which of the three deserves the hours."
steps:
...
faqs:
  - q: "What is the hardest part of GCSE Science for Plymouth students?"
    a: "The six-mark questions and the calculations, roughly in that order. A six-mark answer wants a sequence: state it, explain it, then link back to what the question actually asked. Most students write everything they know in whatever order it arrives. Calculation marks go elsewhere, usually on unit conversion and on rearranging a formula when the unknown sits on the bottom. Required practicals are the third one, revised as a memory of an afternoon rather than as the questions written about them."
