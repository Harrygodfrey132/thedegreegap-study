...
intro_1: Leicester has one of the highest proportions of first-generation
  university aspirants of any city in England. Families here care deeply about
  education, and students often arrive at Year 10 genuinely motivated to do
  well. But GCSE attainment across the city sits below the national average, and
  the gap between what students want to achieve and what their results currently
...
intro_2: The Degree Gap tutoring works with Leicester families to match students
  ...
  problem gets found. It might be gaps in core content from earlier years that
  were quietly skipped over. It might be that a student knows the subject but
  hasn't been taught how to answer exam questions in the way mark schemes
  reward. Whatever the cause, regular tutoring sessions give students the time
  and attention the classroom can't always provide.
about_heading: Private Tutors Serving Leicester Families
about_image: /images/graduation-ceremony-caps.jpg
schools_intro: Students from across Leicester come to The Degree Gap with their
  sights set on competitive sixth forms and strong GCSE outcomes. We work with
  families whose children attend Rushey Mead Academy, Crown Hills Community
  College, Soar Valley College, Judgemeadow Community College, Babington
  Community College and City of Leicester College, among others. We also run
  revision workshops on exam technique and study planning, open to students from
  any Leicester school.
schools:
  - Rushey Mead Academy
...
online_heading: "Online tuition for Leicester students: the right tutor, not
  just the nearest one"
online_1: Most of our sessions with Leicester students run online through
  Lessonspace, a platform built for online tuition with an interactive
  whiteboard at its core. For Maths and the sciences, that means working through
  problems step by step in real time, with the tutor seeing exactly where a
  student hesitates or makes a slip. Leicester students tend to settle into it
  quickly, often within the first session.
online_2: Online tutoring also removes the constraint of geography. Leicester
  has strong tutoring demand but the right specialist isn't always in your
  postcode. Our online model means we match students with the tutor best suited
  to their subject and goals, rather than whoever happens to live nearby. And
  for busy families, regular weekly sessions online are simply easier to keep.
  Consistency is what actually drives progress.
...
areas_intro: Finding the right tutor matters more than finding the nearest one,
  which is why we support families across Leicester and well beyond.
area_links:
...
faq_2_a: Yes, and it is how most of our sessions run. Students get access to a
...
faq_3_a: Yes. Some of the students we work with in Leicester have gaps
...
faq_4_a: Grades slipping despite effort. Confidence dropping. Putting the work
  ...
  simpler than that. Some students in Leicester just want to go further than the
  classroom pace allows. Either is a good reason to get in touch.
why_heading: Why Leicester families choose The Degree Gap
why_para_1: When students start tutoring with us, the first session usually
  tells the same story. They know the material in a general sense. They've been
  taught it, they've revised it, they can talk about it in conversation. But
  when a tutor puts a past paper question in front of them and asks them to
  write an answer, something stops. The structure isn't there. They don't know
  how to open a response, how much to write, or what the examiner actually
  wants. That gap between knowing content and being able to demonstrate it under
  exam conditions is the thing most classroom teaching doesn't have time to
  close.
why_para_2: That is where we start. Not with more content delivery, but with
  exam technique, mark scheme literacy and timed practice built around the
  specific topics causing the most trouble. Most Leicester students notice a
  shift within the first three or four tutoring sessions, not always in grades
  yet, but in how much less uncertain they feel when a question lands in front
  of them. Parents usually notice it too. The student stops dreading the subject
  and starts being willing to try.
accordion_quality: Every tutor we work with is vetted on subject knowledge and
  on their ability to explain clearly to a student who is stuck. In a city where
  sixth form entry is competitive and the gap between a grade 4 and a grade 6
  genuinely matters, that standard is non-negotiable.
accordion_experience: Our tutors have experience working with students who are
  motivated but whose results haven't caught up with their ambition yet. They
  know how to identify what's actually holding a student back and address it
  without making the student feel behind.
accordion_personalised: Every student starts with a session that finds the real
  gaps, not the ones the student thinks they have. From there, the tutor builds
  each session around what will make the most difference to that student's
  grades, not a generic plan.
reviews:
