...
hero_h1: "Online GCSE English tutoring for Newcastle upon Tyne students who know quotations, not questions"
hero_lead: "The quotations are learned, the plot is known, and the mark still comes back where it was. Our Newcastle upon Tyne GCSE English tutors rehearse the questions themselves, one-to-one online over Lessonspace, because those barely change from one year to the next."
...
angle_stat_from: "5"
angle_stat_to: "7"
angle_stat_detail: "Where a term of weekly one-to-one GCSE English sessions is typically aimed once the question shapes are rehearsed rather than met cold."
...
steps_heading: "Start online GCSE English tutoring in Newcastle upon Tyne in 3 steps"
steps_lead: "Two or three profiles within a day. Tell us the set texts and the board, and whether it is Language, Literature or both that is stuck."
steps:
  - title: "Share your goals"
    body: "Year group, school, exam board, the set texts and which paper is the worry. If your child can talk about Macbeth for ten minutes and writes half a page in the exam, say so, because that is the pattern the sessions are built for."
  - title: "Meet your match"
    body: "Profiles the next day, matched on the board and on the exact texts your child studies, with a free 15-minute video meeting before anything is booked. A tutor who has marked the paper is worth asking for."
  - title: "Start the lessons"
    body: "One hour a week, one-to-one, online on Lessonspace, our shared whiteboard, with the question on screen and the answer written under it, then marked together. Every session is recorded. From £37 an hour, paid one lesson at a time."
...
faqs:
  ...
  - q: "How much English homework should my child do between sessions?"
    a: "About an hour, and rarely more than ninety minutes. For English that usually means one timed answer to the question type from that week's session, written under the clock rather than over an evening, plus one redraft of the answer the tutor marked. The timing is the point: an essay that takes forty minutes at home and twelve in the exam has not been practised at all. Beyond ninety minutes the returns fall away and the student starts to resent the subject, which costs more than the extra practice gains."
