---
# Google Ads landing page for "GCSE Maths tutor" searches, on the design of
# the location level-subject pages (e.g. /locations/birmingham-tutors/gcse/maths/)
# but UK-wide. Not for organic search: noindex, out of the sitemap, and nothing
# on the site links here. The SEO page for this subject is /subjects/gcse-maths-tutor/.
#
# Ad final URL: https://thedegreegap.com/study/gcse-maths-tutor/
...
# ───────────── INSIDE A LESSON (after the steps) ─────────────
lesson:
...
# ───────────── REVIEWS ─────────────
# Names must match data/reviews.yaml. The text comes from there, verbatim.
review_names:
  - "Ellen Logan"
  - "Keira Lei"
  - "Chris Smith"
...
# markup, which a noindex page has no use for.
faq_items:
